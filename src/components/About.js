...
function About() {
  return (
    <section>
      ...
      <p className="text-base text-white text-justify leading-relaxed md:leading-loose mt-4 my-2 mx-4 md:my-4 md:mx-6 dark:text-dark-primary-text">
        ...
        quality time with my beloved wife. I'm enthusiastic about the
        prospect of joining a dynamic team of developers and
        contributing to the realization of our shared vision!
      </p>
      <ScrollIntoView selector="#tech">
        <div className="mx-auto p-10 mt-8">
          <FaChevronDown
            className="animate-bounce mx-auto text-3xl text-white dark:text-black"
            size={34}
          />
        </div>
      </ScrollIntoView>
