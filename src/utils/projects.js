...
export const projects = [
  {
    ...
    image: nt,
    description: ` We envisioned an "accountability" app for users to compare their study statistics with other 100Dev peers. With the help of the MVC architecture, we were able to create an easily navigable environment. This led to more production and less asking of where certain code was located. 
          
          Passport was used for user authentication with bcrypt as a password "salter". When users log in and create an account, they're
          presented with a "create" button that sends a post request to the server, which is then routed to the DB where their "time" statistic is created. We then use these values in the leaderboard and divide the time to show hours, minutes, and seconds respectively.
  ...
  },
  {
    ...
    description: `TPD - Total Product Developers, is a Full-stack MERN application that was built as my capstone project during the 9 month full-stack MERN program at Kenzie Academy. I served as Quality Assurance, Developer, and also implemented user authentication using JWT access and refresh token strategy with an HTTP only cookie, and implemented full CRUD functionality with a user project submission form.
      ...
      I am very proud of the work I put into this project and it is a great addition to my portfolio. I am excited to use the skills I acquired on future projects and as a future stretch goal, I would love to add an admin portal to manage projects on TPD.`,
